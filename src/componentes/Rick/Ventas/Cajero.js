        ...
        <div className="row">
          <div className="col">
            ...
            <nav class="d-flex navbar navbar-icon-top navbar-expand-lg navbar-dark ">
              ...
              <div class="col-sm-5 ">
              <small id="emailHelp" class="form-text text-muted  text-left">Selecciona el cajero</small>
              <select class="custom-select" id="inlineFormCustomSelect">
                        <option selected>Todos</option>
                        <option value="1">Juan Pérez</option>
                        <option value="2">María Martinez</option>
                        <option value="3">Pedro Robles</option>
                      </select>
                      </div>
