        ...
        <div className="row">
          <div className="col">
            ...
            <nav class="d-flex navbar navbar-icon-top navbar-expand-lg navbar-dark ">
              ...
              <input type="date" name="bday" className="ml-4"></input>
                <button class="btn btn-outline-dark my-2 ml-1 my-sm-0 " type="button" data-toggle="modal" data-target="#agregar">Generar por fecha</button>
                <button class="btn btn-outline-dark my-2 ml-1 my-sm-0 " type="button" data-toggle="modal" data-target="#agregar">Generar Histórico</button>
              </div>
            </nav>
